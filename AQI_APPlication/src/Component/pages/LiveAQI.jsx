  ...
  useEffect(() => {
    ...
    const fetchHourlyAQI = async () => {
      try {
        ...
        const data = await response.json();
        setHourlyAQI(data); // Set actual data
      } catch (error) {
        console.error("Error fetching live AQI:", error);
        // Fallback to dummy data in case of an error
        setHourlyAQI(dummyData);
            ...
            >
              ...
              <svg width="90" height="90" viewBox="0 0 100 100">
                ...
                <circle
                  ...
                  cy="50"
                  r="40"
                  stroke={getAqiColor(data.aqi)} // Use AQI color
                  strokeWidth="5"
                  fill="none"
                  strokeDasharray="251.2" // Circumference of the circle
                  strokeDashoffset={251.2 - (data.aqi / 500) * 251.2} // Max value is 500
